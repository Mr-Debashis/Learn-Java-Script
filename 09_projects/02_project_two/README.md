...
## 📂 Project Structure
    ...
    │── style.css      # Styling for form, container, and components
    └── app.js         # Core BMI logic + validation + event handling
...
Users enter: - **Height** in centimeters - **Weight** in kilograms
...
The BMI result is displayed dynamically in the UI.

### 5️⃣ BMI Weight Guide

A built-in guide helps users understand their BMI category.
...
If this helped you, feel free to enhance and expand the project! 🚀
